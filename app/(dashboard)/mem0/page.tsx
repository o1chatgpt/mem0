...
import type { Memory as Mem0Memory } from "@/components/memory"
      ...
      <div className="container mx-auto py-8">
        <div className="mb-8 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={refreshMemories} disabled={isLoading}>
        ...
        {networkError && <NetworkErrorAlert onDismiss={refreshMemories} />}

        {databaseError && <DatabaseConnectionError onDismiss={refreshMemories} />}
                          ...
                          {memories.map((memory) => (
                            <div key={memory.id} className="rounded-lg border p-4">
                              <div className="flex justify-between items-start mb-2">
                                <SimpleMarkdownRenderer content={memory.content} />
