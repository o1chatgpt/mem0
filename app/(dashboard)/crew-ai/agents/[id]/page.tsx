...
export default function AgentDetailPage() {
  ...
  const { agents, tasks, loading, error, selectAgent, selectedAgent, fetchTasksByAgent, tablesExist } = useCrewAI()
  ...
  useEffect(() => {
    if (id) {
      selectAgent(id)
      // Only try to fetch tasks if tables exist
      if (tablesExist) {
        fetchTasksByAgent(id)
      }
    }
  }, [id, selectAgent, fetchTasksByAgent, tablesExist])
          ...
          {!tablesExist ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  The CrewAI database tables have not been set up yet. Please set up the database to view and manage
                  tasks.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild>
                  <Link href="/crew-ai">Set Up CrewAI</Link>
                </Button>
              </CardContent>
            </Card>
          ) : (
