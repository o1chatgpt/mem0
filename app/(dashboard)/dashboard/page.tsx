...
import { Users, FileText, PenToolIcon as Tool, Database, Code, Briefcase, AlertTriangle, Brain } from "lucide-react"
...
const dashboardItems = [
  ...
  {
    title: "Mem0",
    description: "Long-term memory for your AI assistants",
    icon: Brain,
    href: "/mem0",
...
export default function DashboardPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="mt-12">
        <h2 className="mb-6 text-2xl font-bold">Recommended Files</h2>
        <FileRecommendations />
      </div>
