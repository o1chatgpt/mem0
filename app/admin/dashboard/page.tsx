    ...
    <div className="container mx-auto py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card>
          ...
          <CardFooter>
            <Link href="/admin/ai-family" className="w-full">
        ...
        <Card>
          ...
          <CardFooter>
            <Link href="/admin/voice-services" className="w-full">
      ...
      <div className="mt-10 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Button variant="outline" asChild>
            <Link href="/admin/ai-family/new">Add AI Family Member</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/admin/tasks/new">Create New Task</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/chat">Open Chat Interface</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/admin/voice-test">Test Voice Services</Link>
          </Button>
        </div>
      </div>
    </div>
