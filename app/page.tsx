...
import { Users, FolderOpen, BrainCircuit, FileText } from "lucide-react"
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        <div className="max-w-md text-center">
          ...
          <p className="mb-4">Supabase connection could not be established. Please check your environment variables.</p>
          <p className="text-sm text-muted-foreground">
            Make sure NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY are properly set.
          </p>
        </div>
      </div>
    )
