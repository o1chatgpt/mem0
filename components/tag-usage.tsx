  ...
  useEffect(() => {
    const loadTagUsageData = async () => {
      ...
      try {
        ...
        const tagData = await processTagUsage(files, (fileId) => memoryStore.getFileTags(fileId))
        ...
        console.error("Error loading tag usage data:", error)
      } finally {
        setIsLoading(false)
      }
    }
