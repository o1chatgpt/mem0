...
export function CollapsibleFooter({ containerRef }: CollapsibleFooterProps) {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-0 left-0 right-0 bg-[hsl(222_47%_11%)] border-t border-gray-800 transition-all duration-300 ease-in-out z-50",
        footerHeight[footerState],
      )}
    >
      <div className="flex items-center justify-between p-2 border-b border-gray-800 bg-[hsl(222_47%_13%)]">
      ...
      {footerState !== "minimized" && (
        <div className="w-full h-[calc(100%-2.5rem)] bg-[hsl(222_47%_11%)]">
