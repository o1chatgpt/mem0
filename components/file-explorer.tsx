...
export function FileExplorer({
      ...
      <li key={item.path} className={isDragging ? "opacity-50" : ""}>
        <div
          className={cn(
            ...
            selectedItem === item.path ? "bg-gray-800/70" : "hover:bg-gray-800/40",
            isDropTargetItem ? "bg-blue-900/30 border border-blue-700/50" : "",
          )}
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <ScrollArea
        className={cn(
          "h-[calc(100%-2rem)] border rounded-md p-2 border-gray-800 bg-[hsl(222_47%_11%)] night-scrollbar",
          isDraggingOver && dropTarget === currentPath ? "bg-blue-900/30 border-blue-700/50" : "",
        )}
